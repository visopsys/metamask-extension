...
describe('DetectTokensController', function () {
  ...
  beforeEach(async function () {
    nock('https://api.infura.io').get(/.*/).reply(200)
  ...
  it('should check and add tokens while on main network', async function () {
    ...
    const erc20ContractAddresses = contractAddressses.filter(
    ...
    const contractAddresssesToDetect = contractAddressses.filter(
