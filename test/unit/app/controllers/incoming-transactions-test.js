...
describe('IncomingTransactionsController', function () {
  ...
  describe('constructor', function () {
    it('should set up correct store, listeners and properties in the constructor', function () {
      ...
      assert.deepEqual(
        incomingTransactionsController.blockTracker,
        MOCK_BLOCKTRACKER
      )
      assert.deepEqual(
      ...
      assert.equal(
        ...
        MOCK_PREFERENCES_CONTROLLER
      )
      assert.equal(
        incomingTransactionsController.getCurrentNetwork(),
        'FAKE_NETWORK'
      )
  ...
  describe('#start', function () {
    it('should set up a listener for the latest block', function () {
      ...
      const blockTrackerListenerCallback = incomingTransactionsController.blockTracker.addListener.getCall(
        0
      ).args[1]
      assert.equal(incomingTransactionsController._update.callCount, 0)
